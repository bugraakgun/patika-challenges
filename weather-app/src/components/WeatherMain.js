...
function WeatherMain() {
  ...
  const apiKey = "ff22499f9213c89c536099011f67aa56"; //move .env
          ...
          <div className='row'>
            ...
            <div className='col-lg-4 col-md-12 px-5 pt-md-5'>
              ...
              <div className='row my-5 justify-content-center align-items-center'>
                <div className='col-2' >
                  <a href="https://github.com/bugraakgun"><img src={process.env.PUBLIC_URL + '/github.png'} className={`img-fluid logo ${theme}Logo`} alt='github icon' /></a>
                </div>
                <div className='col-2'>
                  <a href="https://www.linkedin.com/in/mbugra/"><img src={process.env.PUBLIC_URL + '/linkedin.png'} className={`img-fluid logo ${theme}Logo`} alt='linkedin icon' /></a>
                </div>
