    ...
    >
      <header className="header">
        ...
        <form
          ...
          mv-action="set(newTodo, newTodo.trim()), if(newTodo != '', add({done: false, text: newTodo}, todo) & set(newTodo, ''))"
        >
          <input
            className="new-todo"
      ...
      <footer className="footer" hidden={todoList.todo.length === 0}>
        <span className="todo-count">
          <strong mv-value="todoLeft">{todoLeft}</strong> görev kaldı
        </span>
